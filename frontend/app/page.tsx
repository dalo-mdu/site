      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-full lg:min-h-full lg:flex-1">
        <div className='w-full lg:min-h-full lg:h-full lg:flex-1 flex lg:justify-center items-center flex-col mb-10 lg:mb-0'>
          ...
          <div className='flex justify-center gap-4 mb-2'>
            <Link href={'https://instagram.com/dalo_mdu'} className='px-5 py-2 flex  items-center gap-2 '>
            ...
            <Link href={'https://www.facebook.com/datalogiforeningen'} className='px-5 py-2 items-center gap-2 flex  '>
            ...
            <Link href={'https://github.com/dalo-mdu/'} className='px-5 py-2 items-center gap-2 flex  '>
